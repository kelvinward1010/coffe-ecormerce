...
import { WrapperAllPrice, WrapperContentInfo, WrapperHeaderUser, WrapperInfoUser, WrapperItem, WrapperItemLabel, WrapperLabel, WrapperNameProduct, WrapperProduct, WrapperStyleContent, WrapperTable } from './style'
      ...
      <WrapperTable>
        ...
        <tr>
          <th style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>Tạm tính</th>
          <th style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>Phí vận chuyển</th>
          <th style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>Tổng cộng</th>
        </tr>
        <tr>
          <td style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>{convertPrice(data?.shippingPrice)}</td>
          <td style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>{convertPrice(priceMemo)}</td>
          <td style={{  
            border: '1px solid black',
            borderCollapse: 'collapse',
            padding: '0 10px'}}>{convertPrice(data?.totalPrice)}</td>
        </tr>
      </table>
      </WrapperTable>
